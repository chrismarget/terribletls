...
var cipherSuites = []*cipherSuite{
	...
	{TLS_RSA_WITH_RC4_40_MD5, 5, 16, 0, rsaKA, suiteDefaultOff, cipherRC4, macMD5, nil},
	{TLS_RSA_WITH_RC4_128_MD5, 16, 16, 0, rsaKA, suiteDefaultOff, cipherRC4, macMD5, nil},
...
func macMD5(version uint16, key []byte) macFunction {
	if version == VersionSSL30 {
		mac := ssl30MAC{
			h:   &md5WithConstantTimeSum{md5.New()},
	...
	f:= func()hash.Hash {
		return  &md5WithConstantTimeSum{md5.New()}
	}
	return tls10MAC{h: hmac.New(newConstantTimeHash(f), key)}
}

type md5WithConstantTimeSum struct {
	hash.Hash
}

// OMG this is terrible
func (d *md5WithConstantTimeSum) ConstantTimeSum(in []byte) []byte {
	return d.Sum(in)
}
...
const (
	...
	TLS_RSA_WITH_RC4_40_MD5                 uint16 = 0x0003
